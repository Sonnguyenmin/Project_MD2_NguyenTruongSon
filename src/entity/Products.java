...
public class Products implements Serializable {
    ...
    public Products(int productId, String sku, String productName, String description, double unitPrice, int stockQuantity, String image, Category categoryId, Date createdAt, Date updatedAt) {

...
public class ProductManagement {
    private ProductsFeatureImpl productsFeature = new ProductsFeatureImpl();
    ...
    private void handleAddNewProduct() {
        ...
        for (int i = 0; i < countProduct; i++) {
            ...
            product.setProduct_id(productsFeature.getNewId());
    ...
    private void handleShowListProduct() {
        if (productsFeature.getAll().size() == 0) {
    ...
    private void handleEditProduct() {
        ...
        newProduct.inputData(categoriesFeature.getAll());
        productsFeature.save(product);
    ...
    private void handleDeleteProduct() {
        ...
        System.out.println(GREEN + "Đã xóa thành công sản phẩm " + indexProduct + RESET);
    }
